package dev.lucho.freemarker_poc.config;

import dev.lucho.freemarker_poc.model.ErrorResponse;
import dev.lucho.freemarker_poc.model.FieldError;
import dev.lucho.freemarker_poc.util.NotFoundException;
